...
$sql="INSERT INTO location(State,LGA) VALUES(:state,:location)";
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner mt-5" >
                ...
                <div class="row d-flex justify-content-center align-items-center">
                    <div class="col s12">
                        <div class="page-title" style="color:green;">Add Location</div>
                    </div>
...
<?php $sql = "SELECT state from state";
$query = $dbh -> prepare($sql);
$query->execute();
...
<input id="location" type="text"  class="validate" autocomplete="off" name="location"  required>
                                                <label for="deptname">Enter Location</label>
                                            </div>
