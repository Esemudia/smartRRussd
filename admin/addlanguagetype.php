...
$sql="INSERT INTO language(Language,description) VALUES(:leavetype,:description)";
...
<input id="language" type="text"  class="validate" autocomplete="off" name="language"  required>
                                                <label for="leavetype">Language Type</label>
                                            </div>
