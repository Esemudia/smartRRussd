       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner mt-5" >
                ...
                <div class="row d-flex justify-content-center align-items-center">
                    <div class="col s12">
                        <div class="page-title" style="color:green;">Add State</div>
                    </div>
...
<input id="state" type="text"  class="validate" autocomplete="off" name="state"  required>
                                                <label for="deptname">Enter State Name</label>
                                            </div>
